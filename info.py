...
API_ID = int(environ.get('API_ID', '22107616'))
API_HASH = environ.get('API_HASH', '6629084d27f421f2375a57f233e471e2')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002244102666'))
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001909796512')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://toxomod:KGiIr1hg9PyTKpxP@cluster0.ybz8biu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'WOLVERINE_P') # Support Chat Link Without https:// or @
